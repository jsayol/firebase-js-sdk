...
import { StorageAdapter, validateStorageAdapter } from '../persistence/storage/StorageAdapter';
...
export class Database implements FirebaseService {
  ...
  private checkFrozen_(apiName: string) {
    if (this.frozen_) {
      fatal(`Calls to ${apiName} must be made before any other usage of the database`);
    }
  }
